...
export GITOPS_REPO_URL=https://github.com/rhtap-rhdh-qe/go-wdvnbchy-gitops
...
export COSIGN_PUBLIC_KEY="LS0tLS1CRUdJTiBQVUJMSUMgS0VZLS0tLS0KTUZrd0V3WUhLb1pJemowQ0FRWUlLb1pJemowREFRY0RRZ0FFTElNa3MyVzBWWlgrb2VFVC9jR1hzMUs5S0dJVgoraHVsSFd0TFk5TS9tUWFYRDh6Z2p4UnFRTGhzRUd2TGlLZEhYSEV6Ui9VZTdNdVV6Wm9aY01naFlBPT0KLS0tLS1FTkQgUFVCTElDIEtFWS0tLS0tCg=="
...
export REKOR_HOST=${REKOR_HOST-https://rekor-server-tssc-tas.apps.rosa.kx-df47cdce81.053g.p3.openshiftapps.com}
...
export TUF_MIRROR=${TUF_MIRROR-https://tuf-tssc-tas.apps.rosa.kx-df47cdce81.053g.p3.openshiftapps.com}
